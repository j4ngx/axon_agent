...
3. Builds a system prompt that describes Helix and its available tools.
...
_FALLBACK_SYSTEM_PROMPT = "You are Helix, a helpful personal AI assistant. Be concise and accurate."
...
class AgentLoop:
    ...
    Args:
        llm: The LLM client (usually a :class:`~helix.llm.FallbackLLMClient`).
        ...
        for tc in response.tool_calls:
            ...
            if tool is None:
                ...
                try:
                    logger.info(
                        "Executing tool",
                        extra={"tool": tc.name, "tool_args": tc.arguments},
                    )
